...
| Embeddings | **Gemini** `text-embedding-004` | Satu provider dengan chat model, sama-sama gratis. Berubah dari rencana awal (OpenAI `text-embedding-3-small`) karena alasan sama: hindari billing. |
